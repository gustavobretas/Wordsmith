            ...
            <div x-show="settings" class="fixed min-w-screen min-h-screen z-50 left-0 w-full transform" x-cloak>
                ...
                <div x-show="settings" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="relative cursor-pointer mb-8 h-56 rounded-lg overflow-hidden">
                                ...
                                <div id="image_preview" class=" w-full h-full">
                                    <div id="removeImage"
                                        ...
                                        onclick="hideImagePreview()">× remove</div>
                            ...
                            <textarea class="bg-white border border-gray-300 rounded-lg py-2 px-4 block w-full appearance-none leading-normal focus:outline-none focus:shadow-outline h-24"
                            ...
                            <div class="flex mb-3 mt-8 items-center px-3 py-1.5 rounded bg-gray-200">
                                <input type="checkbox" name="featured" class="form-checkbox peer"
                                    wire:model="post.featured">
                                <label
                    ...
                    <div class="text-right p-5 flex justify-end" id="delete-post">
                        <div class="text-red-600 underline text-sm cursor-pointer inline-block flex justify-center items-center"
                            data-slug="test">
                ...
                <div x-show="settingsMeta" x-transition:enter="transition ease-out duration-300"
                    ...
                    <div class="p-6">
                        ...
                        <label class="text-gray-600 text-sm font-medium mb-3 inline-block mt-8" for="meta_description">Meta
                            Description</label>
                        <textarea class="bg-white border border-gray-300 rounded-lg py-2 px-4 block w-full appearance-none leading-normal focus:outline-none focus:shadow-outline h-24"
                        ...
                        <div class="codeeditor-wrapper rounded-lg border border-gray-300 overflow-hidden">
                            <textarea class="bg-white border border-gray-300 rounded-lg py-2 px-4 block w-full appearance-none leading-normal focus:outline-none focus:shadow-outline h-64"
                                name="meta_schema" id="meta_schema" cols="30" rows="10"></textarea>
                        </div>

                        <label class="text-gray-600 text-sm font-medium mb-3 inline-block mt-8" for="meta_data">Extra Meta
                            Data</label>
                        <div class="codeeditor-wrapper rounded-lg border border-gray-300 overflow-hidden">
                            <textarea class="bg-white border border-gray-300 rounded-lg py-2 px-4 block w-full appearance-none leading-normal focus:outline-none focus:shadow-outline h-64"
